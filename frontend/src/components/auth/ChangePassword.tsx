...
const ChangePassword: React.FC<{setIsLogin: React.Dispatch<React.SetStateAction<boolean>>}> = ({setIsLogin}) => {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    if (newPassword !== confirmNewPassword){
        ...
        setIsloading(true);
        changePasswordApi({oldPassword, newPassword, navigate, setIsloading, setIsLogin});
        setOldPassword('');
        setNewPassword('');
